...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 30, 2022 at 09:46 PM
...
CREATE TABLE `tb_barang` (
  ...
  `ke_db_online` varchar(10) NOT NULL DEFAULT 'Belum'
...
INSERT INTO `tb_barang` (`no_barang`, `kode_barang`, `nama`, `harga_jual`, `jumlah`, `foto`, `ke_db_online`) VALUES
(1, '123asd', 'asda', '123,123', 1497, 'brothers.jpg', 'Sudah'),
(2, '435sdf', 'asdasd', '345,345', 3453, '79f509f5451cf0e66e0fa92bcf45a79ee95793b4_hq.jpg', 'Sudah'),
(3, '456dfg', 'sdfgsdf', '345,546', 4570, '6564e6d48892e6ba325bda1ec27189c9b4b3b473_hq.jpg', 'Sudah'),
(4, '454sfd', 'dsfsdf', '546,546', 456, 'Vorpal Sword.jpg', 'Sudah'),
(5, 'sdfds3', '23423asdasd', '234,234', 2357, '11073968_844405842264361_5190470711960847490_n.jpg', 'Sudah'),
(6, 'dfgh42', 'dfgfdg', '342,342', 234, '1-brjYnVlXwM3j_SWXImT0Rg.png', 'Sudah'),
(7, 'dfg345', 'sdfsdf', '345,345', 4353, 'pemotong padi 1.jpg', 'Sudah'),
(8, 'sdf234', '234sdfsdf', '234,234', 2342, '11073968_844405842264361_5190470711960847490_n.jpg', 'Sudah'),
(9, 'fh4534', '34534', '345,345', 3453, '11073968_844405842264361_5190470711960847490_n.jpg', 'Sudah'),
(10, 'fgds23', 'ef3234', '242,342', 2342, '11073968_844405842264361_5190470711960847490_n.jpg', 'Sudah'),
(11, 'sd2342', 'sdfsdf', '234,234', 2342, 'asdasd.jpg', 'Sudah'),
(12, '134ash', 'asdasd', '345,453', 3427, '27661905_1607403089353960_2137003018_n.jpg', 'Sudah'),
(13, 'fgh654', '546', '456,456', 4564, '11073968_844405842264361_5190470711960847490_n.jpg', 'Sudah'),
(14, 'asd565', 'fdsfsdf', '345,234', 2318, '11073968_844405842264361_5190470711960847490_n.jpg', 'Sudah'),
(15, 'hf3454', '324234', '234,234', 2343, '79f509f5451cf0e66e0fa92bcf45a79ee95793b4_hq.jpg', 'Sudah'),
(16, 'gfh456', 'dfgdfg', '50,000', 218, 'wp1987433-gin-ichimaru-wallpapers.jpg', 'Sudah');
...
CREATE TABLE `tb_login` (
  `no_login` int(3) NOT NULL,
  `username` varchar(100) NOT NULL,
  `password` varchar(150) NOT NULL,
  `no_user` int(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tb_login` (`no_login`, `username`, `password`, `no_user`) VALUES
(1, 'admin', 'e739279cb28cdafd7373618313803524', 1);
...
INSERT INTO `tb_log_history` (`no_log`, `no_barang`, `status`, `ket`, `waktu`, `ke_db_online`) VALUES
...
(80, 16, 'Edit Detail Produk', '{\"nama_lama\":\"dfgdfg\",\"nama_baru\":\"dfgdfg\",\"harga_lama\":\"50,000\",\"harga_baru\":\"50,000\",\"foto_lama\":\"wp1987505-gin-ichimaru-wallpapers.jpg\",\"foto_baru\":\"wp1987423-gin-ichimaru-wallpapers.jpg\",\"bertanggungjawab\":\"1\"}', '2022-01-21 04:05:21', 'Sudah'),
(81, 16, 'Edit Detail Produk', '{\"nama_lama\":\"dfgdfg\",\"nama_baru\":\"dfgdfg\",\"harga_lama\":\"50,000\",\"harga_baru\":\"50,000\",\"foto_lama\":\"wp1987423-gin-ichimaru-wallpapers.jpg\",\"foto_baru\":\"wp1987433-gin-ichimaru-wallpapers.jpg\",\"bertanggungjawab\":\"1\"}', '2022-01-21 04:08:36', 'Sudah'),
(82, 3, 'Penjualan Barang Spesifik', '{\"jumlah_pembelian\":\"2\",\"harga_jual\":\"345,546\",\"stok_sebelumnya\":\"4572\",\"stok_sekarang\":4570,\"total_harga\":691092}', '2022-01-21 04:09:37', 'Sudah'),
...
(84, NULL, 'Penjualan Produk', '{\"total_belanja\":\"791,092\",\"pembayaran\":\"800,000\",\"baki\":\"8,908\",\"ket\":[{\"id\":3,\"kode_barang\":\"456dfg\",\"jumlah\":\"2\",\"harga_jual\":\"345,546\",\"nama\":\"sdfgsdf\",\"total\":691092,\"jumlah_stok_sebelumnya\":\"4572\",\"jumlah_stok_sekarang\":4570},{\"id\":16,\"kode_barang\":\"gfh456\",\"jumlah\":\"2\",\"harga_jual\":\"50,000\",\"nama\":\"dfgdfg\",\"total\":100000,\"jumlah_stok_sebelumnya\":\"220\",\"jumlah_stok_sekarang\":218}]}', '2022-01-21 04:09:37', 'Sudah');
...
INSERT INTO `tb_user` (`no_user`, `nama`, `status`) VALUES
(1, 'Admin', 'admin');
...
--
ALTER TABLE `tb_login`
  MODIFY `no_login` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tb_user`
  MODIFY `no_user` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tb_login`
  ADD CONSTRAINT `tb_login_ibfk_1` FOREIGN KEY (`no_user`) REFERENCES `tb_user` (`no_user`) ON DELETE CASCADE ON UPDATE CASCADE;
